<div class = "row">
	<div class = "col-md-offset-4 col-md-4 col-md-offset-4">
		<?php echo form_open('', array('class' => 'well'));?>
			<?php echo form_fieldset('Ajouter un groupe utilisateur');?>
			
			<div class = "form-group">
				<?php echo form_label('Nom du groupe : <b class = "text-danger">*</b>', 'group_name');?>
				<input  value = "<?php echo set_value('group_name');?>" type="text" name = "group_name" class="form-control tooltip-input" placeholder="Nom du groupe ..." required title = "Entrez le nom du groupe." />
			...
			<ul class="list-group">
				...
				<li class="list-group-item">
					...
					<div class="btn-switch pull-right">
						<input id = "<?php echo $key;?>" name = "group_permissions[]" type="checkbox" value = "<?php echo $key;?>" class = "tooltip-input" title = 'Activer pour choisir cette permission' />
