									...
									<form class="" method="post" action="#">
										...
										<div class="form-group">
											...
											<div class="cols-sm-10">
												<div class="input-group">
													...
													<input type="text" class="form-control" name="paiement_montant" value="<?php echo $liste_paiement->paiement_montant;?>" id="paiement_nom"  placeholder="Montant du paiement"/>
												</div>
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="cols-sm-10">
												<div class="input-group">
													<span class="input-group-addon"><i class="fa fa-user fa" aria-hidden="true"></i></span>
													<input type="text" class="form-control" name="paiement_motif" value="<?php echo $liste_paiement->paiement_motif;?>" id="paiement_prix"  placeholder="Motif du paiement"/>
												</div>
											</div>
										</div>
										<div class="form-group">
											...
											<div class="cols-sm-10">
												<div class="input-group">
													<span class="input-group-addon"><i class="fa fa-user fa" aria-hidden="true"></i></span>
													<input type="text" class="form-control" name="paiement_prime" value="<?php echo $liste_paiement->paiement_prime;?>" id="paiement_prix"  placeholder="Prime du paiement"/>
												</div>
											</div>
										</div>
