			...
			<div class="row">
				...
				<div class="col-md-3">
					<ul class="nav nav-pills nav-stacked">
						...
						<li><a href="<?php echo site_url('produit/add'); ?>"><i class="fa fa-pencil-square-o fa-fw"></i>Modifier un produit</a></li>
									...
									<form class="" method="post" action="#">
										...
										<div class="form-group">
											...
											<div class="cols-sm-10">
												<div class="input-group">
													...
													<input type="text" class="form-control" value="<?php echo $liste_produit->produit_nom;?>" name="produit_nom" id="produit_nom"  placeholder="Nom du produit"/>
												</div>
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="cols-sm-10">
												<div class="input-group">
													<span class="input-group-addon"><i class="fa fa-user fa" aria-hidden="true"></i></span>
													<input type="text" class="form-control" name="produit_prix" value="<?php echo $liste_produit->produit_prix;?>" id="produit_prix"  placeholder="Prix du produit"/>
												</div>
											</div>
										</div>
